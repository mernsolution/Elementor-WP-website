...
function dmb_rpts_plan_display() {
	...
	<div class="dmb_toolbar">
		<div class="dmb_toolbar_inner">
			<a class="dmb_button dmb_button_large dmb_expand_rows" href="#"><span class="dashicons dashicons-editor-expand"></span> <?php _e('Expand all', RPT_TXTDM ) ?>&nbsp;</a>&nbsp;&nbsp;
			<a class="dmb_button dmb_button_large dmb_collapse_rows" href="#"><span class="dashicons dashicons-editor-contract"></span> <?php _e('Collapse all', RPT_TXTDM ) ?>&nbsp;</a>&nbsp;&nbsp;
			<a class="dmb_show_preview_table dmb_button dmb_button_huge dmb_button_gold"><?php _e('Instant preview', RPT_TXTDM ) ?></a>
		...
		foreach ( $pricing_table as $pricing_plan ) {
			...
			<div class="dmb_main">
				...
				<div class="dmb_handle">
					...
					<a class="dmb_button dmb_button_large dmb_clone_row" href="#" title="Clone"><span class="dashicons dashicons-admin-page"></span><?php _e('Clone', RPT_TXTDM ); ?></a>
					<div class="dmb_clearfix"></div>
				</div>
				...
				<div class="dmb_inner">
					...
					<div class="dmb_grid dmb_grid_40 dmb_grid_first">
						...
						<input class="dmb_field dmb_highlight_field dmb_title_of_plan" type="text" name="plan_titles[]" value="<?php echo $plan['_rpt_title']; ?>" placeholder="<?php _e('e.g. Platinum', RPT_TXTDM ) ?>" />
					</div>
					...
					<div class="dmb_grid dmb_grid_60 dmb_grid_last">
						...
						<input class="dmb_field dmb_subtitle_of_plan" type="text" name="plan_subtitles[]" value="<?php echo $plan['_rpt_subtitle']; ?>" placeholder="<?php _e('e.g. Our best deal', RPT_TXTDM ) ?>" />
					</div>
					...
					<div class="dmb_grid dmb_grid_25">
						<div class="dmb_field_title">
							...
							<a class="dmb_inline_tip dmb_tooltip_medium" data-tooltip="<?php _e('Add custom CSS classes that will be added to this plan, separated by spaces.', RPT_TXTDM ) ?>">[?]</a>
						</div>
	...
	<div class="dmb_main dmb_empty_plan" style="display:none;">
		...
		<div class="dmb_inner">
			...
			<div class="dmb_grid dmb_grid_40 dmb_grid_first">
				...
				<input class="dmb_field dmb_highlight_field dmb_title_of_plan" type="text" name="plan_titles[]" value="" placeholder="<?php _e('e.g. Platinum', RPT_TXTDM ) ?>" />
			</div>
			...
			<div class="dmb_grid dmb_grid_60 dmb_grid_last">
				...
				<input class="dmb_field dmb_subtitle_of_plan" type="text" name="plan_subtitles[]" value="" placeholder="<?php _e('e.g. Our best deal', RPT_TXTDM ) ?>" />
			</div>
